...
import de.tudarmstadt.ukp.dkpro.keyphrases.core.filter.factory.PositionFilterFactory;
    ...
    public void test() throws ResourceInitializationException, AnalysisEngineProcessException
    {
        ...
        AnalysisEngine engine = AnalysisEngineFactory.createEngine(
                AnalysisEngineFactory.createEngineDescription(
                        ...
                        PositionFilterFactory.getPositionFilter(0,10)));

        JCas jcas = engine.newJCas();
        jcas.setDocumentLanguage("en");
        jcas.setDocumentText("This sentence has more than 10 characters.");
        engine.process(jcas);
